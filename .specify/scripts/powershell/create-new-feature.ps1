...
if ($Help) {
    Write-Output "Usage: ./create-new-feature.ps1 [-Json] [-ShortName <name>] [-Number N] <feature description>"
    Write-Output ""
    Write-Output "Options:"
    Write-Output "  -Json               Output in JSON format"
    Write-Output "  -ShortName <name>   Provide a custom short name (2-4 words) for the branch"
    Write-Output "  -Number N           Specify branch number manually (overrides auto-detection)"
...
function Get-NextBranchNumber {
    ...
    try {
        ...
        Write-Debug "git fetch failed: $_"
    }
